...
import RecipeCard from "@/components/others/recipe-card";
import RecipeCardSkeleton from "@/components/others/recipe-card/recipe-card-skeleton";
...
const RecipeDetails = () => {
  ...
  return (
    <>
      <NextSeo
        title={`${title} - Food Recipe`}
        description={`${title} recipe - Food Recipe`}
        canonical={detailsPageURL}
        openGraph={{
          title: title,
          description: `${title} - Food Recipe`,
          images: [
            {
              url: recipeDetails?.recipe.image ?? "",
            },
          ],
